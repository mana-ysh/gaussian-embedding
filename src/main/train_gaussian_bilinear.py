...
def train(args):
    ...
    if args.restart:
        ...
        model = GaussianBilinearModel(n_entity, n_relation, args.dim, args.cmin, args.cmax, opt, args.tri, args.init_sigma)
...
if __name__ == '__main__':
    ...
    p.add_argument('--init_sigma', type=float, default=10)
